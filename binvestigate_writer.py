...
class BinvestigateWriter():
    ...
    def do_everything(self,base_path):
        ...
        if able_to_find == 'success':
            ...
            temp=open('/home/rictuar/coding_projects/fiehn_work/gc_bin_base/archives/binvestigate_pull/gc_binbase_results_'+self.bin_id_min+'.null','w')
            temp.write('null')
            temp.close()
...
if __name__ == '__main__':
    ...
    this_min=90001 #26754
    this_max=1000000 #26755
    this_gap=10000
    ...
    for i in range(this_min,this_max,this_gap):
        ...
        my_BinvestigateWriter.do_everything('/home/rictuar/coding_projects/fiehn_work/gc_bin_base/archives/binvestigate_pull/gc_binbase_results_')        
